  ...
  void _inviteClubLeader(String userId, String title, String message) async {
    ...
    if (currentUser != null) {
      try {
        ...
        final currentUserAgencyId = currentUserSnapshot.get('agency_id');

        // Fetch agency name of the current user
        ...
        // Check if there is already an invitation sent to this club leader by this agency
        ...
        if (existingInvitations.docs.isEmpty) {
          ...
          if (title.isNotEmpty && message.isNotEmpty) {
            await _firestore.collection('invitations').add({
              ...
              'agencyName': currentUserAgencyName, // Add agency name here
