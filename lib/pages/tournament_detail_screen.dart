...
class _TournamentDetailScreenState extends State<TournamentDetailScreen> {
  ...
  void initState() {
    super.initState();
    if (widget.tournament.containsKey('id')) {
      fetchTournamentData(widget.tournament['id'].toString());
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.tournament['name'] ?? 'Tournament Details'),
      ),
      body: isLoadingData
