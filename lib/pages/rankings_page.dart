...
import 'user_profile.dart'; // Import UserProfile class
  ...
  Future<String> _fetchProfilePicture(String bladerName) async {
    try {
      final QuerySnapshot userSnapshot =
          await _firestore.collection('users').where('blader_name', isEqualTo: bladerName).get();
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => UserProfilePage(
          bladerName: player['blader_name'], // Pass blader_name to UserProfilePage
        ),
      ),
    );
  }
